...
var lista = "";
	for (var i in coders) {
		lista = lista + "<div class= 'div-coder'><p>" + "Nombre : " + coders[i].nombre +"</p><p>Apellido: "+ coders[i].apellido+
			     		"</p><p>Promoción: "+ coders[i].promocion + "</p><p>Estado: "+ coders[i].estado+"</p></div>";
	}
